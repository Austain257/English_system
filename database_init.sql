...
CREATE TABLE `users` (
  ...
  `avatar` varchar(500) DEFAULT '/assets/images/default-avatar.png' COMMENT '头像URL',
...
CREATE TABLE `user_books` (
  ...
  `book_name` varchar(120) NOT NULL COMMENT '课本名称',
  `book_code` varchar(120) DEFAULT NULL COMMENT '课本标识/英文代号',
  `description` varchar(255) DEFAULT NULL COMMENT '简介',
  `cover_url` varchar(255) DEFAULT NULL COMMENT '封面地址',
  `word_count` int DEFAULT NULL COMMENT '预计词汇量',
  `visibility` enum('PRIVATE','PUBLIC') NOT NULL DEFAULT 'PRIVATE' COMMENT '可见范围',
